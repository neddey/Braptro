SMODS.Joker {
	...
	loc_vars = function(self, info_queue, card)
		return { vars = { G.GAME.current_round.gammaray_card.nextboss } }
	end,

    calculate = function(self, card, context)
        local function get_new_boss()
        ...
        if context.setting_blind then
            G.GAME.current_round.gammaray_card.nextboss = get_new_boss()
        end
...
function Game:init_game_object()
	local ret = igo(self)
	ret.current_round.gammaray_card = { nextboss = 'None' }
	return ret
end
